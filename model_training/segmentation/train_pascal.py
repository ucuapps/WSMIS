...
train_ds = PascalSegmentationDataset(config['train']['path'], transform=train_transform, image_set='train',
                                     masks_folder=config['train']['masks'])
val_ds = PascalSegmentationDataset(config['val']['path'], transform=val_transform, image_set='validation',
