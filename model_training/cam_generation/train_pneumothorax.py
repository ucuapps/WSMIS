...
train_ds = PneumothoraxClassificationTrainDataset(config['train']['path'], transform=train_transform)
val_ds = PneumothoraxClassificationTrainDataset(config['val']['path'], transform=val_transform)
...
val_dl = torch.utils.data.DataLoader(val_ds, batch_size=config['batch_size'], drop_last=True, num_workers=12)
