...
train_ds = PascalClassificationDataset(config['train']['input_path'], transform=train_transform, image_set='train',
                                       return_name=True, return_size=True)
val_ds = PascalClassificationDataset(config['val']['input_path'], transform=val_transform, image_set='validation',
                                     return_name=True, return_size=True)
